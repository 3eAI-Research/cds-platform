...
export const ErrorCode = {
  ...
  BIZ_DOCUMENT_TOO_LARGE: 'BIZ_DOCUMENT_TOO_LARGE',
  BIZ_INVALID_DOCUMENT_TYPE: 'BIZ_INVALID_DOCUMENT_TYPE',

  // --- Business Rules: Credit / AI Assistant ---
  ...
  BUS_STORAGE_QUOTA_EXCEEDED: 'BUS_STORAGE_QUOTA_EXCEEDED',
