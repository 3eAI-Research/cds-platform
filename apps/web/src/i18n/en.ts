export const en = {
  ...
  demand: {
    ...
    floor: "Floor",
    fromEstate: "Move-out property",
    toEstate: "Move-in property",
    garden: "Garden",
